...
NatsClient.prototype.sendRequest = function (method, params, serviceId) {
	var self = this;
	self.validateRequest(method, params, serviceId);
	var channelName = serviceId ? self.serviceName + ":" + serviceId : self.serviceName;
